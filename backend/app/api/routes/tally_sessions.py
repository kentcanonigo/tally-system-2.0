...
def read_tally_session(session_id: int, db: Session = Depends(get_db)):
...
def create_tally_session(tally_session: TallySessionCreate, db: Session = Depends(get_db)):
...
def delete_tally_session(session_id: int, db: Session = Depends(get_db)):
